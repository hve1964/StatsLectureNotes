...
$E_{i}$ ($i=1\ldots,k$) amount to count data with unknown maxima
according to the Poisson distribution discussed in Sec.~\ref{sec:poissonverteil}, their standard deviations are $\sqrt{E_{i}}$
and so their variances $E_{i}$; cf., e.g., Jeffreys
